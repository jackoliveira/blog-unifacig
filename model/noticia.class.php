...
class Noticia {
  ...
  public function consultar($id) {
    $query = "SELECT noticia.id noticia_id, noticia.titulo noticia_titulo, noticia.texto noticia_texto, noticia.publicado_em noticia_publicado_em,
                     usuario.nome usuario_nome, foto.nome foto_nome, foto.caminho foto_caminho,
